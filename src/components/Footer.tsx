				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-8">
					...
					<div className="flex flex-col gap-4">
						...
						<p className="text-rose-200/80 text-sm leading-relaxed text-pretty">
							Unindo o acolhimento emocional da doulagem com a segurança técnica
							da enfermagem obstétrica. Por um nascer respeitoso e fundamentado
							em evidências.
						</p>
						...
						<div className="flex items-center gap-4 mt-2">
							<a
								href="https://instagram.com/elasdoparto"
								target="_blank"
								rel="noreferrer"
								className="bg-brand-red-800 p-2 rounded-full hover:bg-rose-600 hover:text-white transition-all text-rose-200"
						...
						<ul className="space-y-3">
							{mainLinks.map((link) => (
								<li key={link.name}>
									<Link
										to={link.to}
										className="text-rose-200 hover:text-white hover:translate-x-1 transition-all duration-200 inline-block text-sm"
									>
										{link.name}
									</Link>
								</li>
					...
					<div>
						<h3 className="text-white font-dm_serif text-lg mb-4">
							Fale Conosco
						</h3>
						<div className="space-y-4 text-rose-200 text-sm">
							{/* Telefones Clicáveis */}
							<div className="flex flex-col gap-1">
								<span className="font-bold text-white text-xs uppercase tracking-wider opacity-70">
									Enfermeira Obstétrica
								</span>
								<a
									href="https://wa.me/5521976942293"
									target="_blank"
									rel="noreferrer"
							...
							<div className="flex flex-col gap-1">
								...
								<a
									href="https://wa.me/5521976437693"
									target="_blank"
									rel="noreferrer"
									className="hover:text-white transition-colors"
								>
