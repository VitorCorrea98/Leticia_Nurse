		...
		<div className="min-h-screen flex flex-col">
			...
			<div className="bg-[#F3BCC8] py-24 px-6 md:px-12 flex justify-center flex-grow">
				<div className="max-w-4xl w-full">
					<h1 className="font-dm_serif text-4xl sm:text-6xl md:text-7xl leading-tight mb-12 text-[#D67C8C] opacity-90 break-words">
						{/* Adicionei 'inline-block' ou 'block' se quiser controlar melhor a quebra */}
						<span className="text-[#BF6376] font-bold block md:inline">
							Acompanhamento dos
						</span>{" "}
						{/* O <br> pode atrapalhar no mobile se o texto já estiver quebrando sozinho. 
            Mudei para 'hidden md:block' para que a quebra forçada só aconteça no PC. */}
					...
					<div className="font-open_sans text-lg md:text-xl leading-relaxed text-justify space-y-6 text-[#9C5263]">
						<p>
							...
							dentro do possível. Uma gestante considerada de risco habitual
							pode deixar de sê-lo se algum exame apresentar alterações, por
							isso, todos os exames são fundamentais para atualização do risco e
							das condutas obstétricas.
						</p>
						<p>
							Como enfermeira obstétrica, acompanho de forma próxima os
							resultados dos exames pré-natais de todas as minhas gestantes. Meu
							papel não é realizar o pré-natal, mas sim atuar paralelamente,{" "}
							<span className="font-bold">
						...
						<p>
							...
							solicitar outros, e apoiar a gestante no diálogo com o
							profissional que realiza o pré-natal. Esse acompanhamento contínuo
							ajuda a reduzir riscos, aumentar a segurança e promover um cuidado
							mais personalizado, baseado em evidências e no respeito à saúde da
							mulher.
						</p>
						<p>
							...
							acompanhamento do histórico gestacional é extremamente importante
							na tomada de decisão. Além disso, permite que a equipe esteja
							preparada para eventuais intercorrências e reduzindo complicações
							relacionadas a comorbidades. Isso significa mais segurança e
							tranquilidade para a gestante e sua família, do início da gestação
				...
				<div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
					...
					<div className="w-full md:w-1/2 z-10">
						<p className="font-open_sans text-xl md:text-2xl text-center md:text-left leading-relaxed">
							Para esse acompanhamento, eu desenvolvi uma caderneta preenchida
							online por mim, com todos os resultados exames, medicações,
							suplementações, que inclusive podem ser solicitados por mim,
							durante o pré-natal.
						</p>
					</div>
					...
					<div className="w-full md:w-1/2 flex justify-center md:justify-end">
						<div className="relative w-full max-w-md transform md:rotate-3 transition-transform hover:rotate-0 duration-500">
							...
							{Img_Caderneta ? (
								<img
									src={Img_Caderneta}
									alt="Caderneta de acompanhamento"
